...
class AgentState(TypedDict, total=False):
    ...
    Attributes:
        ...
        intent_status: Intent detection result ('CONTINUATION', 'NEW_TOPIC', 'IRRELEVANT').
        clarifying_question: Question generated by Intent Analyzer for IRRELEVANT queries.
